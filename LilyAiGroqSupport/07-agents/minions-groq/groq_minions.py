...
# LOCAL_MODEL: local Ollama model to use (set via environment variable, or edit here)
LOCAL_MODEL = os.environ.get("LOCAL_MODEL", "<your-local-ollama-model>")
# GROQ_MODEL: Groq model to use (set via environment variable, or edit here)
...
#Set up your local model, served locally via Ollama (set LOCAL_MODEL to the name of your local Ollama model)
...
#Set up your remote model, hosted on Groq (set GROQ_MODEL to the ID of your Groq model)
