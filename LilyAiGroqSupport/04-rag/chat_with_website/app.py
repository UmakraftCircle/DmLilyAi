...
# Comma-separated list of Groq model IDs to offer in the dropdown (set via environment variable, or edit here)
GROQ_MODELS = [m.strip() for m in os.environ.get("GROQ_MODELS", "<your-groq-model-id>").split(",") if m.strip()]
