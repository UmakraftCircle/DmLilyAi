...
# GROQ_SPEECH_MODEL: Groq speech-to-text model (set via environment variable, or edit here)
GROQ_SPEECH_MODEL = os.environ.get("GROQ_SPEECH_MODEL", "<your-groq-speech-model-id>")
...
def transcribe_audio_in_chunks(audio_path: Path, chunk_length: int = 600, overlap: int = 10) -> dict:
    """
    Transcribe audio in chunks with overlap with a Groq speech model via Groq API.
