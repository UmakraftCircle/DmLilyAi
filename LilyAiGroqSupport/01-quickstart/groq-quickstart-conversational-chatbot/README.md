...
**Groq Integration**: Utilizes the Groq API to generate responses, leveraging the power of a Groq-hosted model (set the `GROQ_MODEL` environment variable to the model ID you want to use).
