...
```yaml
model_list:
  - model_name: groq-model ### MODEL Alias ###
    litellm_params: # all params accepted by litellm.completion() - https://docs.litellm.ai/docs/completion/input
      model: groq/<your-groq-model-id> ### MODEL NAME sent to `litellm.completion()` ###
...
| Model Name             | Usage                                                       |
|------------------------|-------------------------------------------------------------|
| <your-groq-model-id>   | `completion(model="groq/<your-groq-model-id>", messages)`   |
