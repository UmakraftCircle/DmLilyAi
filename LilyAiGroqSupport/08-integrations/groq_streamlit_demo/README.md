...
- **Model Selection**: Users can select between the Groq models listed in the `GROQ_MODELS` environment variable (a comma-separated list of model IDs) to tailor the conversation according to the capabilities of each model.
