...
export const ROUTES = [
  ...
  { id: "leaderboard", label: "Leaderboard", icon: "leaderboard", group: "Workspace", desc: "Tracked uma.moe circle rank, points and fans", load: () => import("/Leaderboard/leaderboard.js") },
